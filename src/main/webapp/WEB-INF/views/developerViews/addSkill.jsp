...
<h2 class="btn-success">ADD SKILL FOR DEVELOPER</h2>
<br/>
<br/>

<form class="row g-3" method="POST" action="developers/addSkill">
    <input type="hidden" name="developerId" value="${developerId}">
    <div class="col-md-6">
        <strong>Choose Skill</strong>
        <select class="form-select" aria-label="Default select example" name="skillId">
